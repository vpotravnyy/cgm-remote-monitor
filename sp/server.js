...
function init () {
    const logger = {};
    logger.info = function (msg) { console.log("SP: " + msg) };
    logger.error = function (msg) { console.error("SP: " + msg) };
    
    /**
     * LibreLink Up Credentials
     */
    const LINK_UP_USERNAME = process.env.SP__LINK_UP_USERNAME;
    const LINK_UP_PASSWORD = process.env.SP__LINK_UP_PASSWORD;
